...
public class Library {
    ...
    private ArrayList<library.Publication> list = new ArrayList();
    ...
    public void addPublication(library.Publication p) { list.add(p); }
    ...
    public <Patron> void checkOut(int publicationIndex, Patron pa) {
    }
